...
class gen_product(models.TransientModel):
    ...
    def create_product(self, values):
        ...
        if (values.get('tracking') == 'By Lots') and (categ_type in ('consu','product')):
            tracking = 'lot'
        elif (values.get('tracking') == 'By Unique Serial Number') and (categ_type in ('consu','product')):
            tracking = 'serial'
        else:
            tracking = 'none'
        ...
        for row_no in range(sheet.nrows):
            ...
            if row_no <= 0:
                ...
                if self.product_option == 'create':
                    ...
                    if (line[13] == 'By Lots') and (categ_type in ('consu','product')):
                        tracking = 'lot'
                    elif (line[13] == 'By Unique Serial Number') and (categ_type in ('consu','product')):
                        tracking = 'serial'
                    else:
                        tracking = 'none'
