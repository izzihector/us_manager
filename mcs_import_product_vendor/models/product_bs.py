...
class mcs_tampungan_do(models.Model):
    _name 				= 'mcs.tampungan.import.bs'
    _description 		= 'MCS | Tampungan Import products BS'
...
class mcs_produk_bs_import(models.TransientModel):
	_name 		 	= "mcs.import.produk.bs"
	_description 	= 'MCS | Import Products BS'
								...
								if Pricelist:
									...
									if Location:
										if line[0] == 'Product':
											...
											# create tampungan
											Createtampungan = self.env['mcs.tampungan.import.bs'].create({
												'name'              	: 'Data Import',
												'kode'					: int(kode),
											...
											kode = str(line[1].replace(".0", ""))
											CekTampungan = self.env['mcs.tampungan.import.bs'].sudo().search([('kode', '=', int(kode))],limit=1)
											if CekTampungan:
												...
												if CekWarna:
													...
													CekAttributLine = self.env['product.template.attribute.line'].sudo().search([('product_tmpl_id', '=', CekTampungan.product_tmpl_id.id),('attribute_id', '=', 1)],limit=1)
													...
													if CekAttributLine:
														...
														CreateAttruteid = self.env['product.template.attribute.line'].create({
															'product_tmpl_id'     	: CekTampungan.product_tmpl_id.id,
															'attribute_id'     		: 1,
															'active'     				: True,
														})
												...
												if CekSize:
													CekAttributLine = self.env['product.template.attribute.line'].sudo().search([('product_tmpl_id', '=', CekTampungan.product_tmpl_id.id),('attribute_id', '=', 5)],limit=1)
												...
												if CekModel:
													CekAttributLine = self.env['product.template.attribute.line'].sudo().search([('product_tmpl_id', '=', CekTampungan.product_tmpl_id.id),('attribute_id', '=', 2)],limit=1)
													if CekAttributLine:
														# jika atribute ada maka di edit untk nambahkan value di attribute yg sama
														# edit variant yg ada
												...
												if CekTema:
													CekAttributLine = self.env['product.template.attribute.line'].sudo().search([('product_tmpl_id', '=', CekTampungan.product_tmpl_id.id),('attribute_id', '=', 6)],limit=1)
													if CekAttributLine:
														# jika atribute ada maka di edit untk nambahkan value di attribute yg sama
														# edit variant yg ada
												...
												if CekMotif:
													CekAttributLine = self.env['product.template.attribute.line'].sudo().search([('product_tmpl_id', '=', CekTampungan.product_tmpl_id.id),('attribute_id', '=', 3)],limit=1)
													if CekAttributLine:
														# jika atribute ada maka di edit untk nambahkan value di attribute yg sama
														# edit variant yg ada
												...
												if CekBahan:
													CekAttributLine = self.env['product.template.attribute.line'].sudo().search([('vendor_product_id', '=', CekTampungan.vendor_product_id.id),('attribute_id', '=', 10)],limit=1)
													if CekAttributLine:
														# jika atribute ada maka di edit untk nambahkan value di attribute yg sama
														# edit variant yg ada
