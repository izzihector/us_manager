...
class HrApplicant(models.Model):
    ...
    def onchange_job_id(self):
        ...
        result = super(HrApplicant, self).onchange_job_id()
        vals = self._onchange_job_id_internal(self.job_id.id)
        department = self.env['hr.department'].browse(vals['value']['department_id'])
...
class HrContract(models.Model):
    ...
    def _onchange_employee_id(self):
        """ Override to get branch from employee """
        result = super(HrContract, self)._onchange_employee_id()
        if self.employee_id:
