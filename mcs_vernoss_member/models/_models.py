...
class ResPartner(models.Model):
    ...
    def check_phone_number_api(self):
        headers = {
        ...
        url = "%s/loyalty-member/get-member?phoneNumber=%s" % (self.env['ir.config_parameter'].sudo().get_param('vernoss_base_url'), self.phone)
    ...
    def create_member_api(self):
        ...
        url = "%s/loyalty-member/create" % self.env['ir.config_parameter'].sudo().get_param('vernoss_base_url')
    ...
    def update_member_api(self):
        ...
        url = "%s/loyalty-member/update-member" % self.env['ir.config_parameter'].sudo().get_param('vernoss_base_url')
