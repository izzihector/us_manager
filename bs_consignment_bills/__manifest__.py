...
{
    "name": """Calculate Vendor Bills from Consigment Sales""",
    "summary": """Calculate vendor bills quantity and price based on consignment sales""",
    "category": "Accounting",
    "version": "13.0.0.1.0",
    ...
    "data": [
        ...
        # wizard
        'views/wizard/wizard_consignment_bills.xml',
